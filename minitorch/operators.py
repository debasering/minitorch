...
def map(fn):
    ...
    return lambda some_list: [fn(element) for element in some_list]
...
def zipWith(fn):
    ...
    return lambda first_list, second_list: [fn(first_list[index], second_list[index])
